        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-nav-link :href="route('dash-categorias')" :active="request()->routeIs('dash-categorias')">
                        {{ __('Categorías') }}
                    </x-nav-link>
                     <x-nav-link :href="route('dash-subcategorias')" :active="request()->routeIs('dash-subcategorias')">
                        {{ __('Subcategorías') }}
                    </x-nav-link>
                    <x-nav-link :href="route('dash-marcas')" :active="request()->routeIs('dash-marcas')">
                        {{ __('Marcas') }}
                    </x-nav-link>
